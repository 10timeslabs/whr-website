...
function GTM_UseCase_1() {
  return (
    ...
    >
      <circle cx="10.793" cy="10.5" r="7.5" stroke="black" strokeWidth="1.5" />
      <path
...
function GTM_UseCase_4() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="12" cy="11" r="9" stroke="black" strokeWidth="1.5" />
      <path
        d="M12 20V22"
        stroke="black"
        strokeWidth="1.5"
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <circle cx="10.5363" cy="9" r="1" fill="black" />
      <circle cx="10.5363" cy="11.6257" r="1" fill="black" />
    </svg>
  );
}
function GTM_UseCase_5() {
  return (
    <svg
      width="24"
      height="24"
...
function GTM_Soln_2() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="18.1494" cy="2.5" r="1.5" fill="#212121" />
      <circle cx="6" cy="2.5" r="1.5" fill="#212121" />
      <circle cx="6" cy="14.5" r="1.5" fill="#212121" />
      <circle cx="18.1494" cy="14.5" r="1.5" fill="#212121" />
      <path
...
function GTM_Soln_3() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="12" cy="12.0425" r="8" stroke="black" strokeWidth="1.5" />
      <path
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="12" cy="8.54248" r="1.5" fill="#212121" />
      <path
  ...
  return (
    ...
    >
      <rect
        ...
        strokeWidth="1.5"
      />
      <circle cx="12" cy="5" r="2" stroke="#212121" strokeWidth="1.5" />
      <path
...
function GTM_Soln_6() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="6" cy="2.96716" r="1.5" fill="#212121" />
      <path
