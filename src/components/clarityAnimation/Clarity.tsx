...
const Clarity = () => {
    ...
    return (
        <div className='w-full flex flex-col items-center justify-center h-[550px] relative'>
            ...
            <div className='font-medium text-[32px]'>Clarity in Chaos</div>
            <div className='text-[var(--secondary-text-color)] text-[20px]'>Real-world can be chaotic; beauty emerges from chaos. </div>
            <div className='flex items-center justify-center w-full mt-10 h-[280px]'>
                <div className='w-[800px] relative flex items-center justify-center h-full'>
                    ...
                    {showText && (
                        <>
                            <div className="absolute top-0 bg-[#F8FBEA] text-[#8B8D52] text-[24px] rounded-xl py-1 px-2">
                            ...
                            <div className="absolute top-[80px] left-0 bg-[#FFF7F5] text-[#AE7562] text-[24px] rounded-xl py-1 px-2">
                            ...
                            <div className="absolute top-[120px] right-0 bg-[#FEF6FF] text-[#9263A0] text-[24px] rounded-xl py-1 px-2">
                            ...
                            <div className="absolute top-[210px] bg-[#F4FAFF] text-[#486D95] text-[24px] rounded-xl py-1 px-2">
