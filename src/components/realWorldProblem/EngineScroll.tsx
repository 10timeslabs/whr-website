...
const EngineScroll = () => {
  ...
  useEffect(() => {
    const observerOptions = {
      root: null, // viewport
      rootMargin: "0px",
      threshold: .7, // Trigger only when fully visible
    };
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const isInView = top < window.innerHeight - 720 && bottom > 520;
        ...
        <div className="flex relative justify-between">
          ...
          <div className="w-[40%] flex flex-col max-[800px]:w-full">
            {data.map((engine, key) => (
              ...
              >
                ...
                {/* This lottie will come for responsive screen */}
          ...
          {isVisible && (
            <div className="w-[50%] relative max-[800px]:hidden">
              <motion.div
                className="fixed top-[250px] w-[43.5%] flex items-center justify-center"
                initial={{
