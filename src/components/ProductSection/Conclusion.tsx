...
const Conclusion = ({ heading, subheading }: Props) => {
    return (
        ...
        >
            <div className='text-[48px] w-[90%] text-center text-[var(--primary-color)] max-[775px]:text-[40px]'>{heading}</div>
            <div className='w-[40%] text-center text-[20px] text-[var(--secondary-text-color)] max-[775px]:text-[16px]'>{subheading}</div>
