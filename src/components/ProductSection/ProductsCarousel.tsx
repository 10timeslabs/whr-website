...
const ProductsCarousel = () => {
  const imageUrl = "https://c1.10times.com/whr/landing/static/image/common";
  const researchImage =
    "https://c1.10times.com/whr/gtm-geo/static/image/product/Research.png";
  const data = [
    {
      topic: "SEARCH",
      heading: "Visualisation Engine",
      subheading:
        "Discover Insights Seamlessly with List, Map, and Calendar Views.",
      bottom: "-20%",
      icon: Researchicon,
    },
    {
      topic: "SMART TRACKERS",
      heading: "Deploy Agents",
      subheading:
        "Activate intelligence with agents that gather and deliver precise data.",
      bottom: "10%",
      icon: Trackericon,
    },
    {
      topic: "DATA MODELLING",
      heading: "Model Enrichment",
      subheading:
        "Transform raw data into actionable insights with advanced enrichment capabilities.",
      bottom: "-10%",
      icon: Modelicon,
    },
    {
      topic: "TRENDS",
      heading: "Identify Trends",
      subheading:
        "Uncover Patterns, Predict Future Movements, and Stay Ahead of the Curve.",
      bottom: "0%",
      icon: Trendsicon,
    },
    {
      topic: "CONSULTING",
      heading: "Consultant Service",
      subheading:
        "Get Tailored Insights to Answer Tough Questions and Drive Strategic Decisions",
      bottom: "-3%",
      icon: Aiicon,
    },
  ];
  ...
  return (
    ...
    >
      <div className="flex flex-col text-center">
        <span className="text-[48px]">Foresee the Future</span>
        <span className="text-[var(--secondary-text-color)] text-[18px]">
          {" "}
          Real-world made predictable for taking proactive action
        </span>
      </div>
      <div className="w-[87%]  relative rounded-xl h-[542px] items-center overflow-hidden flex flex-col justify-start mt-10"  style={{ backgroundImage: `url(${GridImageTwo.src})`, backgroundSize: 'cover', backgroundPosition: 'center'  }}>
        <div
          className="absolute right-0 bottom-[-20%] h-[542px] w-full -z-10"
          style={{
            background: `
        ...
        ></div>
        <div
          className="absolute left-[10%] top-[30%] w-[40px] h-[40px] flex items-center justify-center bg-white rounded-[40px] shadow-md cursor-pointer max-[775px]:hidden"
          onClick={handlePrev}
        >
          <Image src={LeftArrow} alt="left" />
        </div>
        <div className="w-[80%] flex justify-center items-center max-[775px]:justify-between">
          <div
            className="w-[40px] h-[40px] items-center justify-center bg-white rounded-[40px] shadow-md cursor-pointer hidden max-[775px]:flex"
            onClick={handlePrev}
          >
            <Image src={LeftArrow} alt="left" />
          </div>
        ...
        <motion.div
          ...
          style={{
            bottom:
              currentIndex === 0 ? bottomValue : data[currentIndex].bottom,
          }}
        >
          {currentIndex === 0 ? (
            <Image
            ...
            <Image
              src={`https://c1.10times.com/whr/landing/static/image/common/model_enrichment.png`}
              alt="ai"
              width={380}
              height={400}
            />
            ...
            <Image
              src={`${imageUrl}/trends_carousel.png`}
              alt="ai"
              width={700}
              height={370}
              unoptimized
        ...
        <div
          className="absolute right-[10%] top-[30%] w-[40px] h-[40px] flex items-center justify-center bg-white rounded-[40px] shadow-md cursor-pointer max-[775px]:hidden"
          onClick={handleNext}
        >
          <Image src={RightArrow} alt="right" />
        </div>
