	...
	return (
		<div className='pt-[120px] flex flex-col items-center'>
			...
			<div className='flex flex-col items-center'>
				<div className='font-bold text-[40px] text-center w-[90%] max-[850px]:text-[32px]'>{heading}</div>
				<div className='text-[var(--secondary-text-color)] text-center w-[90%]'>{subheading}</div>
