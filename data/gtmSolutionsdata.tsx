...
import {
  GTM_UseCase_1, GTM_UseCase_10, GTM_UseCase_11, GTM_UseCase_12, GTM_UseCase_13, GTM_UseCase_14, GTM_UseCase_15, GTM_UseCase_2, GTM_UseCase_3, GTM_UseCase_4, GTM_UseCase_5, GTM_UseCase_6, GTM_UseCase_7, GTM_UseCase_8, GTM_UseCase_9, GTM_Soln_1,
  GTM_Soln_2,
  GTM_Soln_3,
  GTM_Soln_4,
  GTM_Soln_5,
...
export const gtmSolutionsjsonData = [
  {
    ...
    problem:
      "Identifying all the events that meets & understands your branding goals can be a challenge. It could be all the events in a certain geography or spread across the world. Knowing event opportunity in advance is critical to plan for them, pitch your brand as a sponsor or a speaker",
    solution:
      "With a brand goal defined, you need a solution that would identify, evaluate and recommend the right events for your goals. This solution needs to be comprehensive in it's coverage and be able to match your goals with what the event offers",
    how: `Don't completely depend on your digital footprint, when your can meet your audience in the real-world. Empower your marketing & branding team, by making all events you attend across the organisation to be either in-line with your brand focus or leverage all them events to ensure making brand value. Here is how we can help:
...
h. Access and track all event footprint to access impact`,
  ...
  },
  {
    ...
    subtext:
      "Don't just go, know where your competitors are joining and tend to go",
    problem:
    ...
    solution:
      "A single channel like a Google for the real-world, that tracks physical footprints of companies at events from exhibiting, speaking, sponsoring or attending. Leverage this intel by mapping your competitor list to always stay informed",
...
d. Leverage smart recommendation based on your brand mandate and our AI's ability to look at the whole picture and not just a single data point`,
  ...
  },
  {
    ...
    problem:
      "Have a comprehensive view of all possible events and data around them is still quite challenging and currently done by manual searching, list making and enrichment of data points. Yet, it remain mostly inadequate to do advance matching in today's data driven economy",
    solution:
...
Get a list of events that are upcoming & forecasted. Additionally, get updates whenever an event is founfd that meets the goal`,
  ...
  },
  {
    ...
    subtext:
      "Don't just go by the name, go deeper. Find what you are looking for or be where find the right audience based on products or topics of relevance.",
    problem:
    ...
    how: `Our AI prowered solution doesnt just at the event name & location, rather it takes all the direct and indirect information around the event and it's anticipated audience, creates an event knowledge graph, sorts it in ways that matching closely with product or topic keywords can become possible. So how can you use this: 
...
Get list of events and all future identified events that our AI thinks would be a great fit for your requirement. Continue to train it to improve it's recommendation to be in-line with your company focus`,
    usecases: [
      {
        topic: "Sales & Biz Dev",
        content:
...

  {
    ...
    subtext:
      "It's all about the signals. Link your sales CRM or upload a list of prospective companies to identify the best events for you to attend",
    problem:
      "Everyone is mass emailing, calling or creating content with AI.This noise is only expected to explode and events provide an opportunity that is curated and high on intention. But, tracking which events would be relevant for you and where you are likely to find prospects can be extremely hard. Waiting till post committing to an event can be a huge risk",
    solution:
      "Every event is a great fit for someone, but it does not have to be for you. Instead of blaming the event, it's better to identify events that best map to your potential prospects and which event they would be attending. You need a solution that understands your brand brief, focus and target audience you want to influence. On the basis of your goal it identifies, tracks and scores event that are best fit for you",
...
f. See current upcoming event list and also get notified when new events match your prospect focus`,
  ...
  },
  {
    ...
    how: `Hiring is not just the receruitors job, it's every managers requirement and they might need to be at events they can influence and bring onboard the best candidates. E.g: marketing manager could speak at an event where they could find a good hire. So how do you do this:
...
e. Your tracker would update you on events that could be good to acheive your goals`,
  ...
  },
  {
    ...
    problem:
      "From a small startup to a large enterprise, every company has people who should be out there speaking and spreading the message of the company in one form of the other. Challenge is in identifying events where you could get in, would be a good fit and also ensuring that there is enough time before the event agenda is made to get an opportunity to justify why your candidate would be a good speaker fit for the event",
    solution:
