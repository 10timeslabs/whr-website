...
const imageURL = "https://c1.10times.com/whr/geo/static/image/solution";
export const geoSolutionsjsonData = [
  {
    ...
    solution:
      "Geo enables better predictability of demand by taking into consideration upcoming & forecasted events, along with the estimated impact.",
...
b. Consume data via an API to include in your internal prediction model`,
    ...
    metaData: {
      ...
      image: `${imageURL}/demand-forecasting.png`,
    }
  },
  {
    id: "dynamic-pricing",
    ...
    metaData: {
      ...
      image: `${imageURL}/dynamic-pricing.png`,
    }
  },
  {
    ...
    metaData: {
      ...
      image: `${imageURL}/event-prospecting.png`,
    }
  },
  {
    id: "geo-marketing",
    ...
    metaData: {
      ...
      image: `${imageURL}/geo-marketing.png`,
    }
  },

  {
    ...
    metaData: {
      ...
      image: `${imageURL}/Inventorymanagement.png`,
    }
  },
  {
    ...
    metaData: {
      ...
      image: `${imageURL}/risk-identification.png`,
    }
  },
  {
    id: "travel-advisory",
    ...
    metaData: {
      ...
      image: `${imageURL}/travel-advisory.png`,
    }
  },
  {
    ...
    how: "Geo's single source of truth for events that impact businesses, can help identify volatity in demand basis the nature of a business and its audience filtering. This can be visualized for operational managers to take a call or used by companies in their internal data modeling.",
    usecases: [
      {
        topic: "Hotel & Lodging",
        content:
    ...
    metaData: {
      ...
      image: `${imageURL}/workforce-management.png`,
    }
  },
];
